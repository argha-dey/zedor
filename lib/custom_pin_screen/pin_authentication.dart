...
import '../registration_pages/pin_code_fileld.dart';
import 'theme.dart';
...
class PinAuthentication extends StatefulWidget {
  ...
  final bool? isPinValueSuccess;

  const PinAuthentication({
    Key? key,
    this.action,
    this.isPinValueSuccess,
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Text(
            widget.action ?? "Confirm Passcode",
            style: const TextStyle(
              fontSize: 26,
              fontWeight: FontWeight.bold,
              // color: Colors.white,
          ...
          Text(
            widget.actionDescription ?? "Re-enter passcode to continue",
            style: const TextStyle(
              // color: Colors.white,
              fontSize: 14,
          ...
          Visibility(
              child: Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        'Your passcode match successful',
                        style: TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.bold,
                          color: Colors.green,
              ...
              visible: widget.isPinValueSuccess!),
          const SizedBox(
            height: 50,
          ),
          Expanded(
